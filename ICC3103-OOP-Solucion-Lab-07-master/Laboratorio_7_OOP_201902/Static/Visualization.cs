...
namespace Laboratorio_7_OOP_201902.Static
{
    public static class Visualization
    {
        ...
        public static bool ShowMenuCarga()
        {
            Game game = new Game();
            bool verifi = game.Saved();
            while (verifi == true)
            {
                Console.WriteLine("Desea cargar la partida anterior? ");
                Console.WriteLine("{0} No");
                Console.WriteLine("{1} Si, cargar partida anterior");
                ...
                else if (valorInput != "0" || valorInput != "1")
                {
                    continue;
                }
